...
2. Extract it to some location on your system, for example `/opt/dans.knaw.nl/dd-transfer-to-vault-cli`.
3. Start the service with the following command
   ```
   /opt/dans.knaw.nl/dd-transfer-to-vault-cli/bin/dd-transfer-to-vault-cli server /opt/dans.knaw.nl/dd-transfer-to-vault-cli/cfg/config.yml 
   ```
